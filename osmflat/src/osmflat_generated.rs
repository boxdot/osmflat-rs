...
impl<'a> HeaderMut<'a> {
    ...
    pub fn set_bbox_left(&mut self, value: i64) {
        let buffer = unsafe {
            std::slice::from_raw_parts_mut(self.data, 62)
        };
...
impl<'a> std::fmt::Debug for HeaderMut<'a> {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        HeaderRef { data : self.data, _phantom : std::marker::PhantomData }.fmt( f )
    }
}
...
impl<'a> std::fmt::Debug for TagMut<'a> {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        TagRef { data : self.data, _phantom : std::marker::PhantomData }.fmt( f )
    }
}
...
impl<'a> NodeMut<'a> {
    ...
    pub fn set_id(&mut self, value: i64) {
        let buffer = unsafe {
            std::slice::from_raw_parts_mut(self.data, 20)
        };
        flatdata_write_bytes!(i64; value, buffer, 0, 40)
    }
...
impl<'a> std::fmt::Debug for NodeMut<'a> {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        NodeRef { data : self.data, _phantom : std::marker::PhantomData }.fmt( f )
    }
}
...
impl<'a> NodeIndexMut<'a> {
    ...
    pub fn set_value(&mut self, value: u64) {
        let buffer = unsafe {
            std::slice::from_raw_parts_mut(self.data, 5)
        };
        flatdata_write_bytes!(u64; value, buffer, 0, 40)
    }
...
impl<'a> std::fmt::Debug for NodeIndexMut<'a> {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        NodeIndexRef { data : self.data, _phantom : std::marker::PhantomData }.fmt( f )
    }
}
...
impl<'a> WayMut<'a> {
    ...
    pub fn set_id(&mut self, value: i64) {
        let buffer = unsafe {
            std::slice::from_raw_parts_mut(self.data, 15)
        };
        flatdata_write_bytes!(i64; value, buffer, 0, 40)
    }
...
impl<'a> std::fmt::Debug for WayMut<'a> {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        WayRef { data : self.data, _phantom : std::marker::PhantomData }.fmt( f )
    }
}
...
impl<'a> std::fmt::Debug for TagIndexMut<'a> {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        TagIndexRef { data : self.data, _phantom : std::marker::PhantomData }.fmt( f )
    }
}
...
impl<'a> std::fmt::Debug for NodeMemberMut<'a> {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        NodeMemberRef { data : self.data, _phantom : std::marker::PhantomData }.fmt( f )
    }
}
...
impl<'a> std::fmt::Debug for WayMemberMut<'a> {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        WayMemberRef { data : self.data, _phantom : std::marker::PhantomData }.fmt( f )
    }
}
...
impl<'a> std::fmt::Debug for RelationMemberMut<'a> {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        RelationMemberRef { data : self.data, _phantom : std::marker::PhantomData }.fmt( f )
    }
}
...
impl<'a> std::fmt::Debug for RelationMut<'a> {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        RelationRef { data : self.data, _phantom : std::marker::PhantomData }.fmt( f )
    }
}
...
pub enum RelationMembersRef<'a> {
    NodeMember(<super::osm::NodeMember as flatdata::Struct<'a>>::Item),    WayMember(<super::osm::WayMember as flatdata::Struct<'a>>::Item),    RelationMember(<super::osm::RelationMember as flatdata::Struct<'a>>::Item),}
...
impl<'a> flatdata::VariadicRef for RelationMembersRef<'a> {
    ...
    fn size_in_bytes(&self) -> usize {
        match *self {
            RelationMembersRef::NodeMember(_) => <super::osm::NodeMember as flatdata::Struct<'a>>::SIZE_IN_BYTES,
            RelationMembersRef::WayMember(_) => <super::osm::WayMember as flatdata::Struct<'a>>::SIZE_IN_BYTES,
            RelationMembersRef::RelationMember(_) => <super::osm::RelationMember as flatdata::Struct<'a>>::SIZE_IN_BYTES,
        }
    }
}
...
impl<'a> RelationMembersBuilder<'a> {
    #[inline]
    pub fn add_node_member<'b>(&'b mut self) -> <super::osm::NodeMember as flatdata::Struct<'b>>::ItemMut {
    ...
    #[inline]
    pub fn add_way_member<'b>(&'b mut self) -> <super::osm::WayMember as flatdata::Struct<'b>>::ItemMut {
        let old_len = self.data.len();
    ...
    #[inline]
    pub fn add_relation_member<'b>(&'b mut self) -> <super::osm::RelationMember as flatdata::Struct<'b>>::ItemMut {
        let old_len = self.data.len();
...
impl<'a> flatdata::VariadicStruct<'a> for RelationMembers {
    ...
    {
        match index {
                0 => RelationMembersRef::NodeMember(<super::osm::NodeMember as flatdata::Struct<'a>>::create(data)),
                1 => RelationMembersRef::WayMember(<super::osm::WayMember as flatdata::Struct<'a>>::create(data)),
                2 => RelationMembersRef::RelationMember(<super::osm::RelationMember as flatdata::Struct<'a>>::create(data)),
...
impl flatdata::Archive for Osm {
        ...
        -> ::std::result::Result<Self, flatdata::ResourceStorageError>
    {
        ...
        let relations = Self::read_resource(&*storage, "relations", schema::osm::resources::RELATIONS)?;
        let relation_members = {
            let index_schema = &format!("index({})", schema::osm::resources::RELATION_MEMBERS);
            let index = Self::read_resource(&*storage, "relation_members_index", &index_schema)?;
            let data = Self::read_resource(&*storage, "relation_members", schema::osm::resources::RELATION_MEMBERS)?;            (index, data)
        };
        let tags = Self::read_resource(&*storage, "tags", schema::osm::resources::TAGS)?;
        let tags_index = Self::read_resource(&*storage, "tags_index", schema::osm::resources::TAGS_INDEX)?;
        let nodes_index = Self::read_resource(&*storage, "nodes_index", schema::osm::resources::NODES_INDEX)?;
        let stringtable = Self::read_resource(&*storage, "stringtable", schema::osm::resources::STRINGTABLE)?;
...
impl OsmBuilder {
    #[inline]
    pub fn set_header(&self, resource: <super::osm::Header as flatdata::Struct>::Item) -> ::std::io::Result<()> {
        let data = unsafe {
            ::std::slice::from_raw_parts(resource.data, <super::osm::Header as flatdata::Struct>::SIZE_IN_BYTES)
        };
        self.storage.write("header", schema::osm::resources::HEADER, data)
    }

    #[inline]
    pub fn set_nodes(&self, vector: &flatdata::ArrayView<super::osm::Node>) -> ::std::io::Result<()> {
        self.storage.write("nodes", schema::osm::resources::NODES, vector.as_ref())
    }
    ...
    #[inline]
    pub fn set_ways(&self, vector: &flatdata::ArrayView<super::osm::Way>) -> ::std::io::Result<()> {
        self.storage.write("ways", schema::osm::resources::WAYS, vector.as_ref())
    }
    ...
    #[inline]
    pub fn set_relations(&self, vector: &flatdata::ArrayView<super::osm::Relation>) -> ::std::io::Result<()> {
        self.storage.write("relations", schema::osm::resources::RELATIONS, vector.as_ref())
    }
    ...
    #[inline]
    pub fn set_tags(&self, vector: &flatdata::ArrayView<super::osm::Tag>) -> ::std::io::Result<()> {
        self.storage.write("tags", schema::osm::resources::TAGS, vector.as_ref())
    }
    ...
    #[inline]
    pub fn set_tags_index(&self, vector: &flatdata::ArrayView<super::osm::TagIndex>) -> ::std::io::Result<()> {
        self.storage.write("tags_index", schema::osm::resources::TAGS_INDEX, vector.as_ref())
    }
    ...
    #[inline]
    pub fn set_nodes_index(&self, vector: &flatdata::ArrayView<super::osm::NodeIndex>) -> ::std::io::Result<()> {
        self.storage.write("nodes_index", schema::osm::resources::NODES_INDEX, vector.as_ref())
    }
...
impl<'a> std::fmt::Debug for IndexType40Mut<'a> {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        IndexType40Ref { data : self.data, _phantom : std::marker::PhantomData }.fmt( f )
    }
}
