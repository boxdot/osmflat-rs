...
define_archive!(Osm, OsmBuilder,
    ...
    (header, set_header,
        super::osm::Header,
        schema::osm::resources::HEADER, false);
    // vector resources
    (nodes, set_nodes, start_nodes,
        super::osm::Node,
        schema::osm::resources::NODES, false),
    (ways, set_ways, start_ways,
        super::osm::Way,
        schema::osm::resources::WAYS, false),
    (relations, set_relations, start_relations,
        super::osm::Relation,
        schema::osm::resources::RELATIONS, false),
    (tags, set_tags, start_tags,
        super::osm::Tag,
        schema::osm::resources::TAGS, false),
    (infos, set_infos, start_infos,
        super::osm::Info,
        schema::osm::resources::INFOS, false),
    (tags_index, set_tags_index, start_tags_index,
        super::osm::TagIndex,
        schema::osm::resources::TAGS_INDEX, false),
    (nodes_index, set_nodes_index, start_nodes_index,
        super::osm::NodeIndex,
        schema::osm::resources::NODES_INDEX, false);
    // multivector resources
    (relation_members, start_relation_members,
        RelationMembers,
        schema::osm::resources::RELATION_MEMBERS,
        relation_members_index, super::_builtin::multivector::IndexType40, false);
    // raw data resources
    (stringtable, set_stringtable,
        schema::osm::resources::STRINGTABLE, false);
    // subarchives
);
